      ...
      {open && (
        <motion.div key="modal" exit={{ opacity: 0 }}>
          ...
          >
            {/* Modal pop-up */}
            <div
              className="fixed top-0 left-0 flex flex-col h-screen w-screen m-auto bg-accent-dark text-gray-lightest bg-opacity-90 text-center justify-center items-center"
              onClick={() => setOpen(false)}
            >
              {!hideCloseButton && (
