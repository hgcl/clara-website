...
<Flex>
  <Figure>
    <img
      src="/assets/blog/images/smallcaps-before.png"
      alt="Before: fake small caps"
    />
    <FigCaption>Before: fake small caps</FigCaption>
  </Figure>
  <Figure>
    <img
      src="/assets/blog/images/smallcaps-after.png"
      alt="After: true small caps"
    />
    <FigCaption>After: true small caps</FigCaption>
  </Figure>
</Flex>
...
For reference, here is the `@font-face` I used for my small caps characters:
